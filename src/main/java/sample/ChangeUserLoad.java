...
public class ChangeUserLoad extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        VBox root = null;
        try {
            root = FXMLLoader.load(getClass().getResource("../fxml/ChangeUserLoad.fxml"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        primaryStage.setScene(new Scene(root, 445, 566));//尺寸
