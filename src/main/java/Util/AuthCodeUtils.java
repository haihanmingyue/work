...
public class AuthCodeUtils {
    ...
    private static char[] c = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'j', 'k', 'm', 'n', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', 'A', 'B', 'C', 'D', 'E', 'F',
            'G', 'H', 'J', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W', 'X', 'Y', 'Z', '1', '2' ,'3', '5', '6', '7', '8', '9' , '4'};
...
//        for (int i = 1; i < 5; i++) {
//              FileOutputStream out = new FileOutputStream("E:\\work\\src\\main\\resources\\images"+ i +".png");
//
//              draw(out, getRandom(4));
//              System.out.println(getRandom(4).toLowerCase());
//
//        }
